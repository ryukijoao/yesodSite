...
/* package yesodSite-0.0.0 */
#define VERSION_yesodSite "0.0.0"
#define MIN_VERSION_yesodSite(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  0 || \
...
#define CURRENT_COMPONENT_ID "yesodSite-0.0.0"

#define CURRENT_PACKAGE_KEY "yesodSite-0.0.0"
