...
widgetFormCadastroSimples :: Route Sitio -> Enctype -> Widget -> Text -> Widget
widgetFormCadastroSimples x enctype widget y = $(whamletFile "templates/cadastrosimples.hamlet")